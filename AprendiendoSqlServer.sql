...
exec sp_columns Agenda;
go
insert into agenda (apellido, nombre, domicilio, telefono) values ('Pedro','Pantaleón','Duarte 25','222222');
insert into agenda (apellido,nombre, domicilio, telefono) values ('Jose','Cordero','Conuco','888888');
go
select *from Agenda
go
drop table agenda;
...
--4 - Tipos de datos básicos
 ...
 insert into peliculas(nombre,actor, duracion, cantidad) values('juan', 'pedro', 12, 2);
